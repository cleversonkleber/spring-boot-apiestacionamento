...
public class ParkingSpotController {
    ...
    public ResponseEntity<Object> saveParkingSpot(@RequestBody @Valid ParkingSpotDto parkingSpotDto){
        if(parkingSpotService.existsByLicensePlateCar(parkingSpotDto.getLicensePlateCar())){
            return ResponseEntity.status(HttpStatus.CONFLICT).body("Conflict: Paking Spot is already in use!");
        }
    ...
    public ResponseEntity<Object> updateParkingSpots(@PathVariable(value = "id")UUID id,
        ...
        var parkingModel = parkingSpotModelOptional.get();
        BeanUtils.copyProperties(parkingSpotDto, parkingModel);
        parkingModel.setId(parkingSpotModelOptional.get().getId());
        parkingModel.setRegistrationDate(parkingSpotModelOptional.get().getRegistrationDate());
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(parkingSpotService.save(parkingModel));
    }
